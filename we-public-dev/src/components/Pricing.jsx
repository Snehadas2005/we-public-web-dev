    ...
    const ctx = gsap.context(() => {
      ...
      if (eyebrowRef.current) {
        ...
        eyebrowRef.current.innerHTML = text
          .split('')
          .map((c) => (c === ' ' ? ' ' : `<span class="eb-char">${c}</span>`))
          .join('');
        gsap.to('.eb-char', {
    ...
    <div className="pricing-page">
      ...
      <section className="pricing-intro container" ref={heroRef}>
        <div className="pricing-header">
          ...
          <div className="pricing-section-title-wrap hero-title-wrap">
            <h1
              ref={heroTitleRef}
          ...
          <div
            ref={lineRef}
            className="pricing-hero-line-el initial"
          />

          <p className="pricing-hero-desc initial">
