...
const FEATURES = [
  {
    title: "Operations\n& Billing",
    tagline: "Structure your daily operations with a single, clear system.",
    body: "Create unlimited job cards and invoices effortlessly. Manage flexible billing, counter sales, split payments, and track workshop expenses live.",
    bullets: [
      "Unlimited job cards",     "Flexible tax billing",
      "Multi-payment support",   "Counter sales",
      "Expense tracking",        "Data export (PDF/Excel)",
    ],
    img: "/feature1.png",
  },
  {
    title: "Customer\nExperience",
    tagline: "Transform how customers interact with your garage.",
    body: "Customers get a dedicated mobile app to view job cards, track service progress, book appointments, and receive live WhatsApp notifications.",
    bullets: [
      "Customer mobile app",     "Live service tracking",
      "WhatsApp notifications",  "Direct garage chat",
      "Appointment scheduling",  "Vehicle history",
    ],
    img: "/feature2.png",
  },
  {
    title: "Inventory\n& Suppliers",
    tagline: "Never lose track of your stock or purchases again.",
    body: "Real-time stock tracking, purchase management, and smart supplier profiles. Save time and reduce repeated manual data entry daily.",
    bullets: [
      "Real-time stock tracking", "Purchase management",
      "Supplier auto-fill",      "Reduced manual entry",
      "One-click reports",       "Live dashboard insights",
    ],
    img: "/feature5.png",
  },
  {
    title: "Multi-Branch\n& Staff",
    tagline: "Control everything from one central command system.",
    body: "Manage staff access, oversee daily operations, and control multiple branches side by side. Get complete visibility of your business performance.",
    bullets: [
      "Centralized dashboard",   "Multi-branch control",
      "Staff login & access",    "Admin full control",
      "Performance visibility",  "Compare branches",
    ],
    img: "/feature4.png",
  },
  {
